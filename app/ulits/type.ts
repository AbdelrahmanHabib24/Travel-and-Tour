...
export const PACKAGE = [
  {
    ...
    des: "Discover Florence, the heart of the Italian Renaissance. Explore world-class museums, stunning cathedrals, and the vibrant streets filled with art, fashion, and history.",
    rating: 4.5,
    count: 20,
    ageRange: "0-99",
    maxGroupSize: 19,
  ...
  },
  {
    ...
    des: "Visit the iconic Sydney Opera House, a masterpiece of modern architecture. Experience breathtaking views of Sydney Harbour and immerse yourself in cultural performances.",
    rating: 4.0,
    count: 15,
    ageRange: "0-99",
    maxGroupSize: 19,
  ...
  },
  {
    ...
    des: "Experience the romance of Paris with a visit to the Eiffel Tower. Capture stunning views of the city and enjoy the charm of France’s most iconic landmark.",
    rating: 4.7,
    count: 30,
    ageRange: "0-99",
    maxGroupSize: 19,
  ...
  },
  {
    ...
    des: "Enjoy panoramic views of Hong Kong from Victoria Peak. A must-visit spot offering stunning cityscapes, nature trails, and unforgettable sunsets.",
    rating: 4.8,
    count: 25,
    ageRange: "0-99",
    maxGroupSize: 19,
  ...
  },
  {
    ...
    des: "Explore the breathtaking Amazon Rainforest. Discover exotic wildlife, lush greenery, and the incredible biodiversity of the world’s largest tropical forest.",
    rating: 4.2,
    count: 18,
    ageRange: "0-99",
    maxGroupSize: 19,
  ...
  },
  {
    ...
    des: "Dive into the vibrant culture of Camden Market. Shop unique crafts, fashion, and street food while enjoying London’s most eclectic marketplace.",
    rating: 4.6,
    count: 22,
    ageRange: "0-99",
    maxGroupSize: 19,
  ...
  },
  {
    ...
    des: "Discover the wonders of Komodo National Park. See the legendary Komodo dragons and explore pristine beaches, crystal-clear waters, and rich marine life.",
    rating: 4.5,
    count: 16,
    ageRange: "0-99",
    maxGroupSize: 19,
  ...
  },
  {
    ...
    des: "Experience the beauty of Zurich, Switzerland’s cultural and financial hub. Wander through historic streets, enjoy lakeside views, and taste Swiss delights.",
    rating: 4.3,
    count: 12,
    ageRange: "0-99",
    maxGroupSize: 19,
  ...
  },
  {
    ...
    des: "Visit the Taj Mahal, one of the Seven Wonders of the World. Marvel at the ivory-white marble and the love story behind this timeless monument.",
    rating: 4.9,
    count: 35,
    ageRange: "0-99",
    maxGroupSize: 19,
